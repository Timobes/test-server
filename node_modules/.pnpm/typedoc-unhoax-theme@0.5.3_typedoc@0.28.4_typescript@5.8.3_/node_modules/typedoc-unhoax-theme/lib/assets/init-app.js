import { initPageContentNavFromAnchors, initPageContentNavFromSectionHeadings, } from './init-page-content-nav.js';
...
function closeMobileMenuOnBodyClick() {
    ...
    if (!mobileNavOpenedInput || !pageContent)
        return;
    pageContent.addEventListener('click', (event) => {
        if (!mobileNavOpenedInput.checked)
            return;
