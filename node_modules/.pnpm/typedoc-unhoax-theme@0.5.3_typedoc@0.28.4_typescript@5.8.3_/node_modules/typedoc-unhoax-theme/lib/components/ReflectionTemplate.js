import { DeclarationReflection, i18n, JSX, ReferenceReflection, ReflectionKind, } from 'typedoc';
...
export function ReflectionTemplate({ context, props }) {
    ...
    return (JSX.createElement(JSX.Fragment, null,
        props.model.hasComment() && (JSX.createElement("section", { class: 'comment' },
        ...
        props.model instanceof DeclarationReflection && (JSX.createElement(JSX.Fragment, null,
            ...
            !!props.model.implementedTypes && (JSX.createElement("section", null,
                JSX.createElement("h4", null, i18n.theme_implements()),
                JSX.createElement("ul", { class: 'hierarchy' }, props.model.implementedTypes.map((item) => (JSX.createElement("li", null, context.type(item))))))),
            !!props.model.implementedBy && (JSX.createElement("section", null,
                JSX.createElement("h4", null, i18n.theme_implemented_by()),
                JSX.createElement("ul", { class: 'hierarchy' }, props.model.implementedBy.map((item) => (JSX.createElement("li", null, context.type(item))))))),
            !!props.model.signatures?.length && JSX.createElement("section", null, context.memberSignatures(props.model)),
            !!props.model.indexSignatures?.length && (JSX.createElement("section", { class: `tsd-panel ${context.getReflectionClasses(props.model)}` },
                JSX.createElement("h4", { class: 'tsd-before-signature' }, i18n.theme_indexable()),
                JSX.createElement("ul", { class: 'tsd-signatures' }, props.model.indexSignatures.map((index) => (JSX.createElement(IndexSignature, { context: context, index: index })))))),
...
function IndexSignature({ context, index }) {
